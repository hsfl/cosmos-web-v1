      ...
      },
      {
        ...
        component: {
          ...
          props: {
            ...
            displayValues: [
              {
                name: 'ICRF Position X',
                nodeProcess: 'cubesat1:propagator_simple',
                dataKey: 'node_loc_att_icrf',
                processDataKey: (x) => x.pos.d.x.toFixed(4),
                timeDataKey: 'node_loc_utc',
                unit: '',
              },
              {
                name: 'ICRF Position Y',
                nodeProcess: 'cubesat1:propagator_simple',
                dataKey: 'node_loc_att_icrf',
                processDataKey: (x) => x.pos.d.y.toFixed(4),
                timeDataKey: 'node_loc_utc',
                unit: '',
              },
              {
                name: 'ICRF Position Z',
                nodeProcess: 'cubesat1:propagator_simple',
                dataKey: 'node_loc_att_icrf',
                processDataKey: (x) => x.pos.d.z.toFixed(4),
                timeDataKey: 'node_loc_utc',
                unit: '',
              },
              {
                name: 'ICRF Velocity X',
                nodeProcess: 'cubesat1:propagator_simple',
                dataKey: 'node_loc_att_icrf',
                processDataKey: (x) => x.vel[0].toFixed(4),
                timeDataKey: 'node_loc_utc',
                unit: '',
              },
              {
                name: 'ICRF Velocity Y',
                nodeProcess: 'cubesat1:propagator_simple',
                dataKey: 'node_loc_att_icrf',
                processDataKey: (x) => x.vel[1].toFixed(4),
                timeDataKey: 'node_loc_utc',
                unit: '',
              },
              {
                name: 'ICRF Velocity Z',
                nodeProcess: 'cubesat1:propagator_simple',
                dataKey: 'node_loc_att_icrf',
                processDataKey: (x) => x.vel[2].toFixed(4),
                timeDataKey: 'node_loc_utc',
                unit: '',
              },
            ],
